...
async function requireAdmin(request: AuthedRequest, reply: FastifyReply) {
  ...
  try {
    ...
    request.user = { userId: payload.userId, role: (payload as any).role };
...
export async function adminRoutes(fastify: FastifyInstance) {
  ...
  fastify.get(
    '/admin/privacy/deletion-receipts',
    ...
    async (request: AuthedRequest, reply: FastifyReply) => {
      try {
        ...
        return reply
          .code(500)
          .send({ success: false, error: 'Failed to get deletion receipts' });
      }
    }
  );
  ...
  fastify.get(
    ...
    async (request: AuthedRequest, reply: FastifyReply) => {
      try {
        ...
        return reply
          .code(500)
          .send({ success: false, error: 'Failed to get security dashboard' });
      }
    }
  );
  ...
  fastify.post(
    ...
    async (request: AuthedRequest, reply: FastifyReply) => {
      try {
        ...
        return reply
          .code(500)
          .send({ success: false, error: 'Failed to report incident' });
      }
    }
  );
  ...
  fastify.post(
    ...
    async (request: AuthedRequest, reply: FastifyReply) => {
      try {
        ...
        return reply
          .code(500)
          .send({ success: false, error: 'Failed to start compliance audit' });
      }
    }
  );
}
