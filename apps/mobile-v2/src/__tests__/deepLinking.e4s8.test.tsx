...
describe('E4-S8: Deep Link Routing (Basic)', () => {
  ...
  describe('parseDeepLink', () => {
    it('should parse drishti://paywall correctly', () => {
      ...
      expect(mockLogEvent).toHaveBeenCalledWith('deeplink_open', {
        path: 'paywall',
      });
    });
  ...
  describe('telemetry integration', () => {
    it('should log telemetry for all valid deep links', () => {
      ...
      expect(mockLogEvent).toHaveBeenNthCalledWith(1, 'deeplink_open', {
        path: 'paywall',
      });
      expect(mockLogEvent).toHaveBeenNthCalledWith(2, 'deeplink_open', {
        path: 'accounts',
      });
    });
