/**
 * GoalCalculatorScreen Component
 * Goal Calculator screen
 */
...
type Props = GoalsStackScreenProps<'GoalCalculator'>;

const GoalCalculatorScreen: React.FC<Props> = ({ navigation }) => {
  return (
