/**
 * ScenarioDetailsScreen Component
...
type Props = ScenariosStackScreenProps<'ScenarioDetails'>;

const ScenarioDetailsScreen: React.FC<Props> = ({ navigation }) => {
  return (
...
export default ScenarioDetailsScreen;
