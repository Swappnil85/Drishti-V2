...
import { securityIntegrityService } from '../../services/security/SecurityIntegrityService';
...
const SecuritySettingsScreen: React.FC = () => {
  ...
  useEffect(() => {
    (async () => {
      try {
        const report = await securityIntegrityService.checkIntegrity();
        if (report.isCompromised || report.riskScore >= 40) {
          setIntegrityBanner({
            riskScore: report.riskScore,
            isCompromised: report.isCompromised,
          });
        }
      } catch (_e) {
        // Ignore integrity failures in UI
      }
    })();
  }, []);
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: () => {
            ...
            Alert.alert(
              'Info',
              'Password change flow would be implemented here'
            );
          },
        },
      ]
      ...
      >
        ...
        {integrityBanner && (
          <Card
            variant='outlined'
            padding='md'
            style={[styles.section, { borderColor: '#EF4444', borderWidth: 1 }]}
          >
            <Flex direction='row' align='center' gap='sm'>
              <Icon name='warning' size='md' color='error.500' />
              <View style={{ flex: 1 }}>
                <Text variant='body1' weight='semiBold' color='error.600'>
                  Device Security Risk Detected
                </Text>
                <Text variant='body2' color='text.secondary'>
                  Risk score {integrityBanner.riskScore}/100.{' '}
                  {integrityBanner.isCompromised
                    ? 'Some features may be limited.'
                    : 'Please review your device security.'}
                </Text>
              </View>
            </Flex>
          </Card>
            ...
            <View
              style={[
                styles.scoreProgress,
                {
                  width: `${securityScore}%`,
                  backgroundColor:
                    getSecurityScoreColor(securityScore) === 'success.500'
                      ? '#10B981'
                      : getSecurityScoreColor(securityScore) === 'warning.500'
                        ? '#F59E0B'
                        : '#EF4444',
                },
              ]}
          ...
          <Flex direction='column' gap='lg'>
            ...
            <Flex direction='row' align='center' justify='space-between'>
              ...
              <Switch
                ...
                onValueChange={value =>
                  handleToggleSetting('securitySettings.pinEnabled', value)
                }
              />
            </Flex>
          ...
          <Flex direction='column' gap='lg'>
            <Flex direction='row' align='center' justify='space-between'>
              ...
              <Switch
                ...
                onValueChange={value =>
                  handleToggleSetting('securitySettings.autoLockEnabled', value)
                }
              />
            </Flex>
          ...
          <Flex direction='column' gap='lg'>
            <Flex direction='row' align='center' justify='space-between'>
              ...
              <Switch
                ...
                onValueChange={value =>
                  handleToggleSetting('securitySettings.localOnlyMode', value)
                }
              />
            </Flex>
            ...
            <Flex direction='row' align='center' justify='space-between'>
              ...
              <Switch
                ...
                onValueChange={value =>
                  handleToggleSetting(
                    'securitySettings.cloudSyncEnabled',
                    value
                  )
                }
                disabled={
                  security.localOnlyMode ||
                  (integrityBanner?.isCompromised ?? false)
                }
              />
            </Flex>
          </Flex>
          ...
          <Flex direction='column' gap='lg'>
            <Flex direction='row' align='center' justify='space-between'>
              ...
              <Switch
                ...
                onValueChange={value =>
                  handleToggleSetting('privacySettings.analyticsEnabled', value)
                }
              />
            </Flex>
            ...
            <Flex direction='row' align='center' justify='space-between'>
              ...
              <Switch
                ...
                onValueChange={value =>
                  handleToggleSetting(
                    'privacySettings.performanceDataEnabled',
                    value
                  )
                }
              />
            ...
            <Flex direction='row' align='center' justify='space-between'>
              ...
              <Switch
                ...
                onValueChange={value =>
                  handleToggleSetting(
                    'privacySettings.marketingEmailsEnabled',
                    value
                  )
                }
              />
