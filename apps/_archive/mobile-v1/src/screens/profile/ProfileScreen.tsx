...
const ProfileScreen: React.FC = () => {
  ...
  const handleAdvancedRecommendations = async () => {
    await buttonTap();
    navigation.navigate('AdvancedRecommendations' as never);
  };

  const handlePrivacyDashboard = async () => {
    await buttonTap();
  ...
  const handleExportData = async () => {
    try {
      ...
      Alert.alert('Export Profile Data', 'Choose export format:', [
        {
          text: 'Cancel',
          style: 'cancel',
        ...
        <Card variant='outlined' padding='lg' style={styles.section}>
          ...
          <Flex direction='column' gap='md'>
              ...
              >
                <Flex direction='row' align='center'>
                  ...
                  <View>
                    ...
                    <Text variant='caption' color='info.500'>
                      ML-powered insights
                    </Text>
                  </View>
                </Flex>
            ...
            <Button
              variant='outline'
              size='lg'
              onPress={handlePrivacyDashboard}
              style={styles.actionButton}
            >
              <Flex
                direction='row'
              ...
              >
                <Flex direction='row' align='center'>
                  <Icon
                    ...
                    style={styles.actionIcon}
                  />
                  <Text variant='body1' weight='medium' color='error.500'>
                    Delete Profile
                  </Text>
                </Flex>
