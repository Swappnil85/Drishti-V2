...
type Props = ScenariosStackScreenProps<'EditScenario'>;

const EditScenarioScreen: React.FC<Props> = ({ navigation }) => {
  return (
...
export default EditScenarioScreen;
